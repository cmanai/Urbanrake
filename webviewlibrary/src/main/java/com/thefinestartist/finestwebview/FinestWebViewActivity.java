...
public class FinestWebViewActivity extends AppCompatActivity
    ...
    private static final String TAG = FinestWebViewActivity.class.getSimpleName();
    private String mCM;
    private ValueCallback<Uri> mUM;
    private ValueCallback<Uri[]> mUMA;
    private final static int FCR = 1;
    Context mContext = FinestWebViewActivity.this;
    ...
    protected AppCompatImageButton cancel;
    protected AppCompatImageButton back;
    protected AppCompatImageButton forward;
    protected AppCompatImageButton refresh;
    ...
    protected void initializeOptions() {
        ...
        int selectableItemBackground =
                Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP ? typedArray.getResourceId(5, 0)
    ...
    protected void bindViews() {
        ...
        cancel = (AppCompatImageButton) findViewById(R.id.Cancel_Button);
        back = (AppCompatImageButton) findViewById(R.id.back);
        back.setEnabled(false);
        forward = (AppCompatImageButton) findViewById(R.id.forward);
        refresh = (AppCompatImageButton) findViewById(R.id.Reload_Button);
    ...
    protected void layoutViews() {
        ...
        { // Icons
            updateIcon(cancel, R.drawable.cancel_button);
            updateIcon(back, R.drawable.back);
            updateIcon(forward, R.drawable.forward);
            updateIcon(refresh, R.drawable.reload_button);
        }
    ...
    protected void initializeViews() {
        ...
        { // Icons
            cancel.setBackgroundResource(iconSelector);
            back.setBackgroundResource(iconSelector);
            forward.setBackgroundResource(iconSelector);
            refresh.setBackgroundResource(iconSelector);
...
//            shadowLayout.setShadowColor(menuDropShadowColor);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initializeOptions();
        showToastMessage = Toast.makeText(this, "Press again to exit Urbanrake", Toast.LENGTH_SHORT);
    ...
    public void onClick(View v) {
       ...
       /* if (viewId == R.id.Cancel_Button) {
        ...
        }/* else if (viewId == R.id.Reload_Button) {
            webView.reload();
        }*/
   ...
   /* protected void showMenu() {
    ...
    private class MyWebChromeClient extends WebChromeClient {
        ...
        public void openFileChooser(ValueCallback<Uri> uploadMsg){
            ...
            i.setType("*/*");
            FinestWebViewActivity.this.startActivityForResult(Intent.createChooser(i,"File Chooser"), FCR);
        }
        ...
        public void openFileChooser(ValueCallback uploadMsg, String acceptType){
            ...
            i.addCategory(Intent.CATEGORY_OPENABLE);
            i.setType("*/*");
            FinestWebViewActivity.this.startActivityForResult(
        ...
        public void openFileChooser(ValueCallback<Uri> uploadMsg, String acceptType, String capture){
            ...
            i.addCategory(Intent.CATEGORY_OPENABLE);
            i.setType("*/*");
            FinestWebViewActivity.this.startActivityForResult(Intent.createChooser(i, "File Chooser"), FinestWebViewActivity.FCR);
        }
        //For Android 5.0+
...
//                back.setVisibility(showIconBack ? View.VISIBLE : View.GONE);
        ...
        public boolean shouldOverrideUrlLoading(WebView view, String url) {
            ...
            /*******************************************************
             * Added in support for loginfacebook:
             *******************************************************/
            else if (url.contains("simple-fb-connect")) {
             ...
             *******************************************************/
                ...
                return true;
            } else if (!url.startsWith("https://www.urbanrake.com")) {
